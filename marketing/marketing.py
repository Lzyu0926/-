...
print("CNN eval in train data: loss = %0.6f, accuracy = %0.2f%%" %(eval[0],eval[1]*100))

eval = model1.evaluate(X_validation,y_validation,verbose=0)
print("CNN eval in test data: loss = %0.6f, accuracy = %0.2f%%" %(eval[0],eval[1]*100))

eval = model1.evaluate(food_val,food_ans,verbose=0)
print("CNN eval in food data: loss = %0.6f, accuracy = %0.2f%%" %(eval[0],eval[1]*100))

eval = model1.evaluate(daily_val,daily_ans,verbose=0)
print("CNN eval in daily data: loss = %0.6f, accuracy = %0.2f%%" %(eval[0],eval[1]*100))
