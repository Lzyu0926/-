...
def svm_function(data_vec,new_item):
    ...
    print("================================================")
    print("SVM eval in train data accuracy =",clf.score(X_train,y_train))

    print("SVM eval in validation data accuracy =",clf.score(X_validation, y_validation))

    print("SVM eval in food data accuracy =",clf.score(food_val, food_ans))

    print("SVM eval in daily data accuracy =",clf.score(daily_val, daily_ans))
